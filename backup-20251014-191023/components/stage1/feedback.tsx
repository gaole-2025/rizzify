    ...
    return (
      <div className="space-y-4 rounded-3xl border border-white/10 bg-white/5 p-6 text-white">
        <header className="space-y-1">
          ...
          <p className="text-sm text-white/70">Ticket {submitState.ticketId} has been filed with our support team.</p>
        </header>
        <div className="flex flex-wrap gap-3">
          <button
            type="button"
  ...
  return (
    ...
    >
      <header className="space-y-1 text-white">
        ...
        <p className="text-xs text-white/60">We will link this to your most recent generation for faster support.</p>
      </header>
      ...
      <p className="text-xs text-white/50">
        One submission every {rateLimit.seconds}s. No nudity, impersonation, or minors.
      </p>
    </form>
  )
}
