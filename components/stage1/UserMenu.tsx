        ...
        >
          <ul className="space-y-2">
            ...
            <li>
              <Link
                href="/start"
                className="block rounded-lg px-3 py-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 hover:from-blue-500/30 hover:to-purple-500/30 text-white font-medium transition-colors border border-blue-500/30"
                role="menuitem"
