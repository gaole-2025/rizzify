      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            What changed after switching to <span className="gradient-text">Rizzify</span>
          </h2>
          <p className="text-lg md:text-xl text-light/70 max-w-2xl mx-auto">
            Short notes from people who updated their profiles with our photos.
          </p>
        </motion.div>
        ...
        >
          <div className="text-center">
            ...
            <div className="text-light/60">photo in</div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-light/60">photos out</div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-light/60">with Priority</div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-light/60">JPG / PNG exports</div>
          </div>
        </motion.div>
