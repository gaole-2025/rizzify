      ...
      <div className="container mx-auto px-4 py-8 sm:py-12">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="text-sm sm:text-base font-semibold text-light mb-3 sm:mb-4">Product</h4>
            <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-light/70">
              <li>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="text-sm sm:text-base font-semibold text-light mb-3 sm:mb-4">Support</h4>
            <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-light/70">
              <li>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="text-sm sm:text-base font-semibold text-light mb-3 sm:mb-4">Legal</h4>
            <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-light/70">
              <li>
        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4 text-center sm:text-left">
            <div className="text-xs sm:text-sm text-light/60 space-y-1">
              <div>© 2024 Rizzify. All rights reserved.</div>
              <div>Location: Nanjing, China</div>
            </div>

            {/* Social links */}
            <div className="flex items-center gap-3 sm:gap-4">
              <span className="text-xs sm:text-sm text-light/60">Follow us:</span>
              <a
